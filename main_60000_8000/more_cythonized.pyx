...
if __name__ == '__main__':
    logging.info('script started with 60 000 systems for 8 000 iterations and 25 catalysts per iteration')
    # Run the concurrent processing
    a_small_vent, fit_small_vent = create_systems_and_fitness_concurrent(pore_range=60000, lifetime_range=8000)
