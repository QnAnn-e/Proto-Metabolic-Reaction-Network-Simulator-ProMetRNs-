...
2. perform the data preprocessing on the [full_jcvi_rxn_list.csv](Data/nfiles/full_jcvi_rxn_list.csv) by making use of [data_preprocessing.py](data_preprocessing.py)
